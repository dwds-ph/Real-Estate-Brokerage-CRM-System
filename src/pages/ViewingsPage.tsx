      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            {viewings.length} total viewings
          </p>
        </div>
        <button
                ...
                >
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="rounded-lg bg-red-100 px-3 py-1 text-xs text-red-700 dark:bg-red-900 dark:text-red-300"
                    >
                      ✕ Cancel
                    </button>
                  </div>
                ...
                {viewing.feedback && (
                  <div className="mt-2 text-xs text-muted-foreground">
                    ...
                    {viewing.feedback.concerns && (
                      <p>Concerns: {viewing.feedback.concerns}</p>
                    )}
                  </div>
                )}
              </div>
