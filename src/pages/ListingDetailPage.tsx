          ...
          <div className="space-y-4">
            <div className="rounded-lg border bg-card p-6">
              ...
              <button
                onClick={() =>
                  navigator.clipboard.writeText(
                    `${window.location.origin}/b/${listing.id}`,
                  )
                }
              ...
              <button
                ...
                className="w-full rounded-lg bg-primary/10 px-4 py-2 text-sm font-medium text-primary hover:bg-primary/20 transition-colors mt-2"
              >
                📄 Generate Contract
              </button>
            </div>
