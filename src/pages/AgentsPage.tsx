...
export default function AgentsPage() {
      ...
      <div className="space-y-6">
        ...
        <div className="rounded-lg border bg-card p-8 text-center">
          <p className="text-muted-foreground">
            You are under broker: {userProfile?.brokerId ? 'Connected' : 'Not yet connected to a broker'}
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Invite Form */}
      {showInvite && (
        <form onSubmit={handleInvite} className="rounded-lg border bg-card p-6 space-y-4 max-w-md">
          ...
          {inviteSent && <p className="text-sm text-green-600 dark:text-green-400">Invitation created!</p>}
          <button
            type="submit"
            disabled={saving}
      ...
      {loading ? (
        ...
        <div className="rounded-lg border bg-card p-8 text-center">
          <p className="text-muted-foreground">No agents yet. Invite your first agent!</p>
        </div>
      ) : (
