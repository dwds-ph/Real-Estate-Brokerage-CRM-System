...
export default function CommTemplateManager({
  open,
  onClose,
  onSelect,
  ...
  const [form, setForm] = useState({
    name: "",
    type: "call" as CommTemplate["type"],
    body: "",
  });
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-lg rounded-lg border bg-card p-6 shadow-lg max-h-[80vh] overflow-y-auto animate-scale-in"
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setForm({
                    ...form,
                    type: e.target.value as CommTemplate["type"],
                  })
                }
                className="w-full rounded-lg border bg-background px-3 py-2 text-sm"
              >
