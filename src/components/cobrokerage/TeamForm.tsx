...
export default function TeamForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3">
      <div>
        <label htmlFor="team-name" className="block text-xs font-medium mb-1">
          Team Name *
        </label>
        <input
          id="team-name"
      ...
      <div>
        <label htmlFor="team-desc" className="block text-xs font-medium mb-1">
          Description
        </label>
        <textarea
          id="team-desc"
      ...
      <div>
        <label htmlFor="team-lead" className="block text-xs font-medium mb-1">
          Team Lead *
        </label>
        <select
          id="team-lead"
